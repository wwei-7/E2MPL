...
#     parser.add_argument('--wlr', type=float, default=0.0001, help='learning rate, default=0.005')
#     parser.add_argument('--tsne_lr', type=float, default=100., help='learning rate, default=100')
...
#     parser.add_argument('--init_lambda', type=float, default=1.)
#     parser.add_argument('--init_gama', type=float, default=1.)
#     parser.add_argument('--init_beta', type=float, default=1.)
#     parser.add_argument('--init_eta', type=float, default=1.)
#     parser.add_argument('--init_trans_scale', type=float, default=15.)
...
#     parser.add_argument('--is_softmax', default=False)
...
#     parser.add_argument('--origin_weight', type=float, default=100.)
#     parser.add_argument('--adj_weight', type=float, default=98.)
...
#     parser.add_argument('--class_temperature', type=float, default=1.)
#     parser.add_argument('--discri_temperature', type=float, default=1.)
...
def args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--dataset_dir', default='/data/datasets', help='/miniImageNet')
    parser.add_argument('--split_PATH', type=str, default='/home/hsq/Projects/mini-imagenet-split')
